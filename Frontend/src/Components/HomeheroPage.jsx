  ...
  return (
    <div className='relative w-full min-h-[90vh] flex items-center py-20 px-6 md:px-16 lg:px-36 bg-dark-bg overflow-hidden'>
          <div className='absolute top-0 right-0 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[150px] pointer-events-none' />
            ...
            <div className='relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full sm:p-5'>
                <motion.div 
                ...
                >
                    ...
                    <button 
                        ...
                        className='self-start px-8 py-4 cursor-pointer bg-white text-black rounded-full font-bold hover:bg-gray-200 transition-colors duration-300 shadow-lg shadow-white/10'
                    >
                        Explore All Movies
                    </button>
                </motion.div>
...
<img
  ...
  alt="Hero"
  className="hidden lg:block w-full max-w-lg h-auto rounded-2xl shadow-2xl mx-auto object-cover"
/>
            </div>
